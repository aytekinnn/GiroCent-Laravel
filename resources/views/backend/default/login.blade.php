    ...
    <div class="auth-right py-32 px-24 d-flex flex-column justify-content-center">
        <div class="max-w-464-px mx-auto w-100">
            <div>
                ...
                <h4 class="mb-12">Hesabınıza Giriş apın</h4>
                <p class="mb-32 text-secondary-light text-lg">Tekrar hoş geldin! lütfen bilgileri giriniz.</p>
            </div>
            <form action="{{route('login.authenticate')}}" method="post">
                ...
                <div class="mt-32 text-center text-sm">
                    <p class="mb-0">Hesabınız yok mu? <a href="{{route('register')}}" class="text-primary-600 fw-semibold">Üye Ol</a></p>
                </div>
