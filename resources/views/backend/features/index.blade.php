...
@section('content')
    ...
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0">Özellikler</h6>
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Özellikler</li>
            </ul>
        </div>
                ...
                <div class="modal-dialog modal-dialog-scrollable modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{route('features.create')}}" enctype="multipart/form-data" method="POST"
    ...
    <script>
        console.log(typeof $);
        var featuresDeleteUrl = '{{route('features.delete', ['id' => ':destroy_id'])}}';
        var featuresViewUrl = '{{route('features.view')}}';
    </script>
    <script src="/backend/assets/js/customize/features.js"></script>
@endsection
