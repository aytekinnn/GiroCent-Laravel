...
$('[data-countdown]').each(function () {
	...
	$this.countdown(finalDate, function (event) {
		$this.html(event.strftime('<div class="time-count day"><span>%D</span>Gün</div><div class="time-count hour"><span>%H</span>Saat</div><div class="time-count min"><span>%M</span>Dk</div><div class="time-count sec"><span>%S</span>Sn</div>'));
	});
});
